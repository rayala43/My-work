...
def main():
    ...
    vcf_file = r'C:/Users/GenepoweRx_Madhu/Downloads/vcf_files_all/KHAIGHGPTTL313_final.vcf'
    output_file = r'C:/Users/GenepoweRx_Madhu/Downloads/COVERED_VCF_FILES_BED/KHAIGHGPTTL313_final.vcf'
...
vcf = pd.read_csv(r'C:/Users/GenepoweRx_Madhu/Downloads/COVERED_VCF_FILES_BED/KHAIGHGPTTL313_final.vcf', comment= '#', sep = '\t', header=None, low_memory=False)
...
#merged_3.to_excel(r'C:/Users/GenepoweRx_Madhu/Documents/Processed_vcf_files/KHAIGHGPCAD3_final_depth_vcf_processed.xlsx', index=False)
...
excel_writer = pd.ExcelWriter(r'C:/Users/GenepoweRx_Madhu/Documents/Processed_vcf_files/KHAIGHGPTTL313_final_output.xlsx', engine='xlsxwriter')
