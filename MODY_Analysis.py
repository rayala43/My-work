...
df = pd.read_csv(r'C:/Users/GenepoweRx_Madhu/Downloads/Depth_files_31_mody/COVERED_TSV/Covered_new/matched/output_concatenated.tsv', sep='\t') # Replace with your file path
...
output_directory = r'C:\Users\GenepoweRx_Madhu\Downloads' # Replace with your Folder path
...
folder_path = r'C:/Users/GenepoweRx_Madhu/Downloads/Depth_files/COVERED_TSV/Covered_new/' # Replace with your Folder path
...
excel_file_path = os.path.join(folder_path, 'summary_0.02_Covered_positions.xlsx') # Replace with your file path
excel_df.to_excel(excel_file_path, index=False)

############################# Selective genes HET and HOM count (gnomADg_AF == Global, 0.001, 0.02) ######################################

# Folder path containing the TSV files
folder_path = r'C:/Users/GenepoweRx_Madhu/Downloads/Depth_files/' # Replace with your Folder path
...
# Save the DataFrame as an Excel file
excel_file_path = os.path.join(folder_path, 'summary_3genes_Global.xlsx') # Replace with your file path
excel_df.to_excel(excel_file_path, index=False)
...
# Save the DataFrame as an Excel file
excel_file_path = os.path.join(folder_path, 'summary_new_clin_sig.xlsx') # Replace with your file path
excel_df.to_excel(excel_file_path, index=False)
...
plt.savefig(r'C:/Users/GenepoweRx_Madhu/Downloads/Final_17751406.svg', dpi=250, bbox_inches='tight') # Replace with your file path
...
df = pd.read_excel(r'C:/Variant data collect from the VEP for the specific genes and InDel Files.xlsx') # Replace with your file path
data = pd.read_excel(r'C:/variant and Location and Allele data from the all 31 mody samples.xlsx') # Replace with your file path
...
############################## Global Similarity for all the 31 samples ##################################################################
## extracting the unique variants from all the 31 MODY samples and comparing the similarity between the variants #########################
...
input_folder = r'C:/Users/GenepoweRx_Madhu/Downloads/Depth_files_31_mody/COVERED_TSV/Covered_new/' # Replace with your Folder path
output_folder = r'C:/Users/GenepoweRx_Madhu/Downloads/Depth_files_31_mody/COVERED_TSV/Covered_new/final_CHROM_POS/' # Replace with your Folder path
...
excel_output_file = r'C:/Users/GenepoweRx_Madhu/Downloads/Depth_files_31_mody/COVERED_TSV/Covered_new/final_CHROM_POS/concatenated.xlsx' # Replace with your file path
final_df.to_excel(excel_output_file, index=False)

########################################### Similarity between HET and HOM for all 31 samples ###########################################
## extracting the unique variants along with the Zygosity from all the 31 MODY samples and comparing the similarity between the variants# 
...
hom_excel_output_file = r'C:/Users/GenepoweRx_Madhu/Downloads/Depth_files_31_mody/COVERED_TSV/Covered_new/final_CHROM_POS/hom_concatenated.xlsx' # Replace with your file path
het_excel_output_file = r'C:/Users/GenepoweRx_Madhu/Downloads/Depth_files_31_mody/COVERED_TSV/Covered_new/final_CHROM_POS/het_concatenated.xlsx' # Replace with your file path

hom_df.to_excel(hom_excel_output_file, index=False)
het_df.to_excel(het_excel_output_file, index=False)

################################################## Jaccard similarity Matrix for Global, HET, and HOM ####################################
########################## Extracted the Similarity matrix from the Global, HET, HOM data ################################################ 
...
######################################### Heat Map Generation ############################################################################
# Genarated the Heatmap from the Jaccard Similarity Matrix of Global, HET, and HOM for comparision of similarity between the HET and HOM unique variants #

import matplotlib.pyplot as plt
from itertools import combinations

# Step 1: Load Excel data into a Pandas DataFrame
excel_file = r'C:/Users/GenepoweRx_Madhu/Downloads/Depth_files_31_mody/COVERED_TSV/Covered_new/final_CHROM_POS/OUTPUT_data_map/HOM_data.xlsx' # Replace with your Global/HET/HOM data path
df = pd.read_excel(excel_file)
...
# Show the heatmap
plt.title('Global/HET/HOM Similarity Heatmap')
#plt.savefig(r'C:/Users/GenepoweRx_Madhu/Downloads/Depth_files_31_mody/COVERED_TSV/Covered_new/final_CHROM_POS/OUTPUT_data_map/new_HOM_Similarity_Heatmap.svg', dpi=450, bbox_inches='tight')
plt.show()
