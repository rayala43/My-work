...
def process_vcf(tool, sample, truth_set):
    vcf_path = f'C:/Users/GenepoweRx_Madhu/Downloads/sen_spe_files_07_09_2023/VCC_input_files/new_input_sample/new_bwa_files/{sample}_{tool}.vcf'
    ...
    sensitivity = (TP + FN) / (TP + FN + TN)
    precision = TP / (TP + FP)
    recall = TP / (TP + FN)
    accuracy = (((TP + TN) / n_b) / (TP + TN + FP + FN)) / 100000
...
results_df.to_excel(r'C:/Users/GenepoweRx_Madhu/Downloads/sen_spe_files_07_09_2023/VCC_input_files/new_input_sample/new_bwa_files/new_New_BWA_12652705.xlsx', index=False)
print(results_df)